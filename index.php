...
<body>
    ...
    <main>
        ...
        <div class="after-banner">
            <div class="container">
                <div class="qualidades">
                    ...
                    <div>
                        <div class="qualidade">125 anos de tradição</div>
                ...
                <div class="qualidades hide-mobile">
                    ...
                    <div>
                        ...
                        <div class="adicional">nas regiões sul e sudeste</div>
                    </div>
                </div>
                ...
                <div class="qualidades hide-mobile">
                    ...
                    <div>
                        ...
                        <div class="adicional">para pagamentos no cartão</div>
                    </div>
                </div>
        ...
        <div class="linha-container">
            ...
            <div id="linha-food-service" class="linha">
                ...
                <h3>Linha Food Service</h3>
                <p>Conheça a linha Food Service, composta por chocolates, coberturas e recheios para uso profissional e doméstico.</p>
                <a href="">
                    <p>Ver Tudo </p> 
    ...
    <div class="linha-container">
        <div id="linha-funcional" class="linha">
            ...
            <h3>Linha Funcional</h3>
            <p>Conheça a Linha Nutris, criada para públicos específicos, tais como os diabéticos, os intolerantes à lactose e/ou ao glúten</p>
            <a href="">
                <p>Ver Tudo </p> 
                <div class="ver-tudo"></div>
            </a>
    ...
    <div class="linha-container">
        <div id="linha-tradicional" class="linha">
            ...
            <h3>Linha Tradicional</h3>
            <p>Conheça nossos tabletes e bombons tradicionais, produzidos pelo método convencional com matéria-prima selecionada.</p>
            <a href="">
                <p>Ver Tudo </p> 
                <div class="ver-tudo"></div>
            </a>
